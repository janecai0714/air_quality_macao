...
time_step = 3
n_features = 35
name = 'PM25'  ###please input the column name of prediction
...
def rf_train(train_X, train_Y, test_X, test_Y, scaler_Y, train_data_X, data_for_plot):
    ...
    #rf_model.save('macao_roadside_PM25_rf.h5')
    ...
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_rf_timeline.svg")
    plt.close()
    ...
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_rf_scatter.svg")
    plt.close()
    ...
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_rf_shap.svg")
    plt.close()
...
def svr_train(train_X, train_Y, test_X, test_Y, scaler_Y, train_data_X, data_for_plot):
    ...
    ax.tick_params(labelsize = 12)
    ax.legend(fontsize=12)
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_svr_timeline.svg")
    plt.close()
    ...
    plt.plot(x_points, y_points, linestyle='dashed', color='green')
    ax.set_aspect('equal', adjustable='box')
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_svr_scatter.svg")
    plt.close()
    return rmse, mae, pcc, ktc
...
def ann_train (train_X, train_Y, test_X, test_Y, scaler_Y, train_data_X, data_for_plot):
    ...
    ax.tick_params(labelsize = 12)
    ax.legend(fontsize=12)
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_ANN_timeline.svg")
    plt.close()
    ...
    plt.plot(x_points, y_points, linestyle='dashed', color='green')
    ax.set_aspect('equal', adjustable='box')
    plt.savefig("/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/PM25_ANN_scatter.svg")
    plt.close()
    return rmse, mae, pcc, ktc


def train(train_X, train_Y, test_X, test_Y, scaler_Y, train_data_X, data_for_plot, result_dir):
    model_name = ["SVR"] # "RF", "SVR", "ANN"
    pollutant_name = "PM25"
    num_repeat = 5
...
if __name__=="__main__":
    train_dir ="/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/PM25_2013_2019_tradition.xlsx"
    test_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/PM25_2020_2021_tradition.xlsx"
    train_X, train_Y, test_X, test_Y, scaler_Y, train_data_X, data_for_plot = data_prepare(train_dir, test_dir)
    rmse, mae, pcc, ktc = svr_train(train_X, train_Y, test_X, test_Y, scaler_Y, train_data_X, data_for_plot)

    train_X_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/train_X_tradition.npy"
    train_Y_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/train_Y_tradition.npy"
    test_X_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/test_X_tradition.npy"
    test_Y_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/test_Y_tradition.npy"
    scaler_Y_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/scaler_Y_tradition.bin"
    train_data_X_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/train_data_tradition.pickle"
    data_for_plot_dir = "/home/jianxiu/Documents/air/deep/data/data_macao_roadside/PM25/data_for_plot_tradition.pickle"
    result_dir = "/home/jianxiu/Documents/air/deep/result/result_macao_roadside/PM25/macao_roadside_PM25_tradition.csv"
